...
comment in scripts/ryu_apps/stability_aware_te.py for why 0.3 and not the
...
scripts/mininet_independence_check.py) between h1 and h35 -- the hosts
...
Run as: sudo python3 scripts/ryu_real_congestion_probe.py
(with `ryu-manager --observe-links scripts/ryu_apps/stability_aware_te.py`
